// <copyright file="An8Subdivision.cs" company="Jérémy Ansel">
...
namespace JeremyAnsel.Media.An8
{
    ...
    /// A subdivision.
    /// </summary>
    public sealed class An8Subdivision : An8Component
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="An8Subdivision"/> class.
        /// </summary>
        public An8Subdivision()
        {
        ...
        /// <summary>
        /// Gets or sets the divisions count.
        /// </summary>
        public int Divisions { get; set; }

        /// <summary>
        /// Gets or sets the render divisions count.
        /// </summary>
        public int RenderDivisions { get; set; }
        ...
        internal override void ParseTokens(string[] tokens)
        {
            ...
            foreach (var chunk in chunks)
            {
                ...
                switch (chunk.Ident)
                {
                    ...
                    case "working":
                        this.Divisions = Tokenizer.ReadInt(chunk.Tokens, ref index);
                        break;

                    case "divisions":
                        this.RenderDivisions = Tokenizer.ReadInt(chunk.Tokens, ref index);
                        break;
        ...
        internal override string[] BuildTokens()
        {
            ...
            Tokenizer.BuildOpenChunk(tokens, "subdivision");
            ...
            Tokenizer.BuildNewLine(tokens);
            Tokenizer.BuildOpenChunk(tokens, "working");
            Tokenizer.BuildInt(tokens, this.Divisions);
            Tokenizer.BuildCloseChunk(tokens);

            Tokenizer.BuildNewLine(tokens);
            Tokenizer.BuildOpenChunk(tokens, "divisions");
            Tokenizer.BuildInt(tokens, this.RenderDivisions);
            Tokenizer.BuildCloseChunk(tokens);
