...
packages\OpenCover.4.6.166\tools\OpenCover.Console.exe -register:user -output:build\coverage\results.xml -target:packages\xunit.runner.console.2.0.0\tools\xunit.console.exe -targetargs:"JeremyAnsel.Media.An8.Tests\bin\%Configuration%\JeremyAnsel.Media.An8.Tests.dll -noshadow" "-filter:+[JeremyAnsel.Media.An8]* -[*.Tests]*" -hideskipped:File;Filter;Attribute -returntargetcode
